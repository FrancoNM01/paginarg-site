...
if (is_shop() || is_product_taxonomy()) {
    ...
    $visual = function_exists('paginarg_store_get_archive_visual_url') ? paginarg_store_get_archive_visual_url() : '';
    ?>
        ...
        <div class="container">
            ...
            <?php if (woocommerce_product_loop()) : ?>
                <div class="paginarg-shop-toolbar">
                    <div class="paginarg-shop-toolbar-copy"><?php woocommerce_result_count(); ?></div>
                    <div class="paginarg-shop-toolbar-sort"><?php woocommerce_catalog_ordering(); ?></div>
                </div>
